function initialize() {
    ...
    $.ajax({
        ...
        // Replace state[2] with variable that Andrew is creating for drop-down event
        $.ajax({
            url: "https://maps.googleapis.com/maps/api/geocode/json?address=" + states[2] + "&key=AIzaSyCNTqY8YLLPTLLEL4RHISF8IHShThD3QQs",
            method: "GET"
            ...
            function initMap() {
                var stateClicked = {lat: latitude, lng: longitude };
                ...
                // Pins a marker on 
                var marker = new google.maps.Marker({position: stateClicked, map: map});
